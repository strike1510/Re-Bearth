...
def Jeuroom8(screen,pos_player_x,pos_player_y,VITESSE, HAUTEUR,LARGEUR,CLOCK):
    testpause = False
    WHITE = (255, 255, 255)
    BLACK = (0, 0, 0)
    TRANSPARENT = (0, 0, 0, 0)
    ...
    while running:
        ...
        if 1840 < player_rect.x < 1900 and 330 < player_rect.y < 460:
            jeu.room7.Jeuroom7(screen, 100*LARGEUR/1920, 420*HAUTEUR/1080, VITESSE, HAUTEUR, LARGEUR, CLOCK)
            running = False
